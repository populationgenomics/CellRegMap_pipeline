...
def crm_pipeline(
    ...
    # create a dummy job to reduce the ongoing dependencies
    dummy_job = batch.new_python_job('Checkpoint job')
    dummy_job.depends_on(*_dependent_jobs)
    ...
    for celltype in celltype_list:
        ...
        for gene in genes_list:
            ...
            prepare_input_job.depends_on(dummy_job)
